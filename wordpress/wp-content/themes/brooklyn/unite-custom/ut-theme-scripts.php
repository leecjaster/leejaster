...
if( !function_exists('unite_script_path') ) {
    ...
    function unite_script_path( $type = 'themes' ) {
		...
		$script_path = ! empty( ot_get_option( 'ut_cdn_upload_path' ) ) ? ot_get_option( 'ut_cdn_upload_path' ) : content_url() . DIRECTORY_SEPARATOR . $type . DIRECTORY_SEPARATOR . ot_get_option( 'ut_cdn_theme_path', 'brooklyn' );
