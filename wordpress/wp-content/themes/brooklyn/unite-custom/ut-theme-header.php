		...
		public function create_site_logo( $class = '' ) {
			...
			<?php if( $site_logo ) : ?>
				...
				<div class="site-logo <?php echo $this->style == 'style-9' && !empty( $class ) ? $class : ''; ?>">
					...
					<a class="<?php echo implode(' ', $logo_class ); ?>" href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">
			...
			<?php else : ?>
				...
				<div class="site-logo">
					...
					<h1 class="logo <?php echo implode(' ', $logo_class ); ?>"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">
